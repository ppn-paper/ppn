...
cmd_brats="python -m scripts.image_sample --work_dir working/sampling $model_brats --num_samples 64 --batch_size 64 --timestep_respacing ddim1000 --acceleration 4 --show_progress True --sampleType PPN"
